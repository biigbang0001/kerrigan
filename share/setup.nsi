...
!define MUI_ICON "../../share/pixmaps/kerrigan.ico"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../../release/kerrigan-qt
    File /oname=COPYING.txt ../../COPYING
    File /oname=readme.txt ../../doc/README_windows.txt
    File ../../contrib/debian/examples/kerrigan.conf
    SetOutPath $INSTDIR\share\rpcauth
    File ../../share/rpcauth/*.*
    SetOutPath $INSTDIR\daemon
    File ../../release/kerrigand
    File ../../release/kerrigan-cli
    File ../../release/kerrigan-tx
    File ../../release/kerrigan-wallet
    File ../../release/test_kerrigan
    SetOutPath $INSTDIR
