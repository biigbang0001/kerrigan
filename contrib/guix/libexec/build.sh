...
(
    ...
    # Setup the directory where our Kerrigan build for HOST will be
    # installed. This directory will also later serve as the input for our
    # binary tarballs.
    INSTALLPATH="${PWD}/installed/${DISTNAME}"
    mkdir -p "${INSTALLPATH}"
    # Install built Kerrigan to $INSTALLPATH
    ...
    (
        ...
        # copy over the example kerrigan.conf file. if contrib/devtools/gen-kerrigan-conf.sh
        # has not been run before buildling, this file will be a stub
        cp "${DISTSRC}/contrib/debian/examples/kerrigan.conf" "${DISTNAME}/"
