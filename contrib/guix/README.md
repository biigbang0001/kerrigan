# Bootstrappable Kerrigan Builds

This directory contains the files necessary to perform bootstrappable Kerrigan
Core builds.
...
To build Kerrigan reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/kerrigan-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/kerrigan/guix.sigs).
