...
"""Script for verifying Kerrigan release binaries

This script attempts to download the signature file SHA256SUMS.asc from
github.com and kerrigan-binaries hosting and compares them.
...
WORKINGDIR = "/tmp/kerrigan_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1="https://github.com/kerrigan/kerrigan/releases/download/v"
HOST2="https://github.com/kerrigan/kerrigan/releases/download/v"
VERSIONPREFIX=""
...
def main(args):
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("github.com and kerrigan-binaries hosting signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Kerrigan binary release "
    ...
    for _, binary_filename in hashes_to_verify:
        ...
        if retval != 0:
            if retval == 1:
                ...
                print("gpg error. Do you have the Kerrigan binary release signing key installed?")
            print("gpg output:")
            print(indent(output, '\t'))
