...
official/supported Docker Images found at https://hub.docker.com/r/kerrigan/kerrigand/
...
**NOTE: Please update the image description at https://hub.docker.com/r/kerrigan/kerrigand-develop/ when changing the above text**
