...
class RPCPackagesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.generate(self.wallet, COINBASE_MATURITY + 120)  # blocks generated for inputs
