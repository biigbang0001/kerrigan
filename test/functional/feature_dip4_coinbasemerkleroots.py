...
class LLMQCoinbaseCommitmentsTest(KerriganTestFramework):
    ...
    def set_test_params(self):
        ...
        self.set_kerrigan_test_params(4, 3, extra_args = self.extra_args)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as KerriganTestFramework doesn't support this atm)
