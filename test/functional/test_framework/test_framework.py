...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def setup_nodes(self):
        ...
        """ NOTE! If this method is updated - backport changes to  KerriganTestFramework.setup_nodes"""
    ...
    # TODO: move it to KerriganTestFramework where it belongs
    def dynamically_initialize_datadir(self, mnidx):
        ...
        write_config(os.path.join(new_data_dir, "kerrigan.conf"),
    ...
    def _initialize_chain(self):
        ...
        for i in range(self.num_nodes):
            ...
            initialize_datadir(self.options.tmpdir, i, self.chain, self.disable_autoconnect)  # Overwrite port/rpcport in kerrigan.conf
...
class KerriganTestFramework(BitcoinTestFramework):
    def set_test_params(self):
    ...
    def set_kerrigan_test_params(self, num_nodes, masterodes_count, extra_args=None, evo_count=0):
        ...
        # it can't be disabled for KerriganTestFramework same as BitcoinTestFramework
