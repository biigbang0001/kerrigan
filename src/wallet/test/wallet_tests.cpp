    ...
    // after.
    {
        ...
        BOOST_CHECK_EQUAL(response.write(),
            strprintf("[{\"success\":false,\"error\":{\"code\":-1,\"message\":\"Rescan failed for key with creation "
                      ...
                      "by pruning or data corruption (see kerrigand log for details) and could be dealt with by "
...
/* --------------------------- Kerrigan-specific tests start here --------------------------- */
namespace {
...
BOOST_FIXTURE_TEST_CASE(CreateTransactionTest, CreateTransactionTestSetup)
{
    ...
    // Now use 4 different inputs with a total of 100k satoshis
    {
        coinControl = CCoinControl();
    ...
    // Last use 10 equal inputs with a total of 100k satoshis
    {
        coinControl = CCoinControl();
