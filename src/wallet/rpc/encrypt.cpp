...
RPCHelpMan walletpassphrase()
{
    return RPCHelpMan{"walletpassphrase",
                ...
                "This is needed prior to performing transactions related to private keys such as sending KRGN\n"
            "\nNote:\n"
            ...
            "time that overrides the old one.\n",
                {
                    ...
                    {"mixingonly", RPCArg::Type::BOOL, RPCArg::Default{false}, "Deprecated and ignored."},
                },
...
RPCHelpMan encryptwallet()
{
    return RPCHelpMan{"encryptwallet",
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending KRGN\n"
