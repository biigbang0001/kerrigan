...
static std::vector<RPCResult> DecodeTxDoc(const std::string& txid_field_doc)
{
    return {
        ...
        {RPCResult::Type::OBJ, "saplingTx", /*optional=*/true, "Sapling shielded transaction payload. Only present if type=10 (TRANSACTION_SAPLING)",
        {
            {RPCResult::Type::NUM, "version", "The payload version"},
            {RPCResult::Type::NUM, "spends", "Number of shielded spend descriptions"},
            {RPCResult::Type::NUM, "outputs", "Number of shielded output descriptions"},
            {RPCResult::Type::STR_AMOUNT, "valueBalance", "Net value entering the transparent pool"},
            {RPCResult::Type::NUM, "valueBalanceSat", "Net value in satoshis"},
            {RPCResult::Type::STR_HEX, "bindingSig", "Binding signature (64 bytes)"},
            {RPCResult::Type::ARR, "vSpendDescriptions", "Shielded spend descriptions",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::STR_HEX, "cv", "Value commitment"},
                    {RPCResult::Type::STR_HEX, "anchor", "Merkle tree anchor"},
                    {RPCResult::Type::STR_HEX, "nullifier", "Nullifier"},
                    {RPCResult::Type::STR_HEX, "rk", "Randomized public key"},
                    {RPCResult::Type::STR_HEX, "proof", "Groth16 zero-knowledge proof"},
                    {RPCResult::Type::STR_HEX, "spendAuthSig", "Spend authorization signature"},
                }},
            }},
            {RPCResult::Type::ARR, "vOutputDescriptions", "Shielded output descriptions",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::STR_HEX, "cv", "Value commitment"},
                    {RPCResult::Type::STR_HEX, "cmu", "Note commitment"},
                    {RPCResult::Type::STR_HEX, "ephemeralKey", "Ephemeral public key"},
                    {RPCResult::Type::STR_HEX, "encCiphertext", "Encrypted note ciphertext"},
                    {RPCResult::Type::STR_HEX, "outCiphertext", "Encrypted outgoing ciphertext"},
                    {RPCResult::Type::STR_HEX, "proof", "Groth16 zero-knowledge proof"},
                }},
            }},
        }},
