...
static RPCHelpMan gethmpinfo()
{
    return RPCHelpMan{"gethmpinfo",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            // Report 4-stage bootstrap status
            int stage;
...
static RPCHelpMan gethmpprivilegedset()
{
    return RPCHelpMan{"gethmpprivilegedset",
                    ...
                    {{RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::STR, "tier", "privilege tier (unknown, new, elder, brood)"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            // Hold cs_main for a consistent snapshot across all algo queries
            LOCK(cs_main);
...
static RPCHelpMan getsealstatus()
{
    return RPCHelpMan{"getsealstatus",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            // Hold cs_main while reading CBlockIndex fields
            LOCK(cs_main);
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::OBJ, "commitment", "commitment status for this identity",
                    {
                        ...
                        {RPCResult::Type::BOOL, "has_commitment", /*optional=*/true, "whether identity has any commitment record"},
                        {RPCResult::Type::NUM, "checked_at_height", /*optional=*/true, "height at which commitment was checked"},
                    }
                },
                {RPCResult::Type::OBJ, "tiers", "per-algo tier and privilege records",
                    {
                        ...
                        {RPCResult::Type::NUM, "window_height", /*optional=*/true, "privilege window tip height"},
                    }
                },
                    ...
                    {{RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::BOOL, "identity_valid", "whether identity was valid"},
                            {RPCResult::Type::STR, "tier", "privilege tier at time of attempt"},
                            {RPCResult::Type::BOOL, "committed", "whether identity was committed"},
                            {RPCResult::Type::BOOL, "equivocation_blocked", "whether blocked by equivocation demotion"},
                            {RPCResult::Type::BOOL, "vrf_valid", "whether VRF proof was valid"},
                            {RPCResult::Type::BOOL, "vrf_selected", "whether VRF selected this signer"},
                            {RPCResult::Type::BOOL, "share_produced", "whether a seal share was produced"},
                            {RPCResult::Type::STR, "result", "outcome description"},
                        }
                    }}
                },
                {RPCResult::Type::ARR, "sessions", "active seal sessions",
                    {{RPCResult::Type::OBJ, "", "",
                        {
                            {RPCResult::Type::STR_HEX, "blockhash", "block hash for this session"},
                            {RPCResult::Type::NUM, "height", "block height"},
                            {RPCResult::Type::NUM, "shares", "number of shares collected"},
                            {RPCResult::Type::BOOL, "assembled", "whether seal has been assembled"},
                        }
                    }}
                },
            }
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
        {
            ...
            if (g_seal_manager) {
                ...
                for (const auto& a : attempts) {
                    ...
                    obj.pushKV("algo", GetAlgoName(a.algo));
            ...
            if (g_seal_manager) {
                ...
                for (const auto& s : sessions) {
                    UniValue obj(UniValue::VOBJ);
                    obj.pushKV("blockhash", s.blockHash.ToString());
