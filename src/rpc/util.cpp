...
const std::string EXAMPLE_ADDRESS[2] = {"KJ2YedSBr9ZWADr63aAnfT4DBwgCqMvEmz", "KKwbJxnjv6wN361YerMWmX13pryPwrYBPg"};
...
{
    return "> kerrigan-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleCliNamed(const std::string& methodname, const RPCArgList& args)
{
    std::string result = "> kerrigan-cli -named " + methodname;
