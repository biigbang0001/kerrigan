...
const std::string CURRENCY_UNIT = "KRGN"; // One formatted unit
const std::string CURRENCY_ATOM = "ksat"; // One indivisible minimum value unit
...
enum class FeeEstimateMode {
    ...
    KRGN_KB,      //!< Use KRGN/kB fee rate unit
    KSAT_B,       //!< Use ksat/B fee rate unit
};
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::KRGN_KB) const;
