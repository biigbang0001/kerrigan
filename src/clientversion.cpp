 ...
 * for both kerrigand and kerrigan-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Kerrigan");
...
std::string CopyrightHolders(const std::string& strPrefix, unsigned int nStartYear, unsigned int nEndYear)
{
    ...
    // Check for untranslated substitution to make sure Kerrigan copyright is not removed by accident
    if (copyright_devs.find("Kerrigan") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + strprintf(" %u-%u ", 2026, nEndYear) + "The Kerrigan developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kerrigan-network/kerrigan>";
