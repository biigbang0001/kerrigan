...
public:
    ...
    SERIALIZE_METHODS(CSimplifiedMNListDiff, obj)
    {
        ...
        READWRITE(LIMITED_VECTOR(obj.deletedMNs, 5000), LIMITED_VECTOR(obj.mnList, 5000));
        READWRITE(LIMITED_VECTOR(obj.deletedQuorums, 400), LIMITED_VECTOR(obj.newQuorums, 400));
