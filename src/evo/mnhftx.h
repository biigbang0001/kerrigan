...
private:
    CEvoDB& m_evoDb;
    // TODO: move ProcessBlock/UndoBlock to specialtxman to drop m_chainman/m_qman deps
    // TODO: store only the block hash where each signal was added, not per-block
