...
/**
 * Kerrigan protocol message types. When adding new message types, don't forget
...
// Hivemind HMP messages
extern const char* SEALSHARE;
extern const char* SEALASM;
extern const char* PUBKEYCOMMIT;
};
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Kerrigan non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // development channels. Remember that service bits are just
...
enum GetDataMsg : uint32_t {
    ...
    MSG_SPORK = 6,
    /* 7 - 15 were used in old Kerrigan versions and were mainly budget and MN broadcast/ping related*/
