...
#ifndef KERRIGAN_CRYPTO_BLS_IES_H
#define KERRIGAN_CRYPTO_BLS_IES_H
...
public:
    ...
    {
        READWRITE(obj.ephemeralPubKey, obj.ivSeed, LIMITED_VECTOR(obj.data, 100000));
    }
...
public:
    ...
    {
        READWRITE(obj.ephemeralPubKey, obj.ivSeed, LIMITED_VECTOR(obj.blobs, 400));
    }
};
...
public:
    ...
    {
        if (idx >= blobs.size()) return {};
        return {ephemeralPubKey, ivSeed, blobs[idx]};
    }
};

#endif // KERRIGAN_CRYPTO_BLS_IES_H
