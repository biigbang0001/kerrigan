...
#ifndef KERRIGAN_CONFIG_H

#define KERRIGAN_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Kerrigan developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Kerrigan"
...
/* Define this symbol to build code that uses ARMv8 AES intrinsics */
/* #undef ENABLE_ARM_AES */

/* Define this symbol to build code that uses ARM NEON intrinsics */
/* #undef ENABLE_ARM_NEON */
...
/* Define this symbol to build code that uses SSSE3 intrinsics */
...
/* Define this symbol to build code that uses x86 AES-NI intrinsics */
...
/* Define to 1 if you have the `bcrypt' library (-lbcrypt). */
...
#define PACKAGE_BUGREPORT "https://github.com/kerrigan-network/kerrigan/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Kerrigan"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Kerrigan 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kerrigan"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://github.com/kerrigan-network/kerrigan"
