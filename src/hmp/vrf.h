 ...
 * Threshold weighted by tier: Elder 3x, New 1x
 *
...
inline constexpr int HMP_VRF_BASE_THRESHOLD = 200;

/** Tier multipliers for VRF selection probability */
inline constexpr int HMP_VRF_BROOD_MULTIPLIER = 4;  // BroodNode: 80% selection rate
inline constexpr int HMP_VRF_ELDER_MULTIPLIER = 3;
inline constexpr int HMP_VRF_NEW_MULTIPLIER = 1;
 ...
 * Brood = 4x (80%), Elder = 3x (60%), New = 1x (20%)
 */
