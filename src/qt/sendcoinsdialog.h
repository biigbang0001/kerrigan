...
private:
    ...
    // Execute a shielded send via ShieldedSendWorker on a background thread
    void sendShielded(const QList<SendCoinsRecipient>& recipients, bool relockOnComplete = false);
