...
/** Utility functions used by the Kerrigan Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kerrigan:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Check if a kerrigan specific theme is activated (light/dark).*/
