      ...
      walletModel(wallet_model)
{
    ...
    shieldedTransactionsPage = new ShieldedTransactionsPage();
    shieldedTransactionsPage->setWalletModel(walletModel);
    addWidget(shieldedTransactionsPage);
...
void WalletView::gotoShieldedTransactionsPage()
{
    setCurrentWidget(shieldedTransactionsPage);
}
