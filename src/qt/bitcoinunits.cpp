...
QList<BitcoinUnit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(Unit::KRGN);
    unitlist.append(Unit::mKRGN);
    unitlist.append(Unit::uKRGN);
    unitlist.append(Unit::ksats);
    return unitlist;
}
...
QString BitcoinUnits::name(Unit unit)
{
    ...
    switch (unit) {
    case Unit::KRGN:  return is_mainnet ? QString("KRGN") : QString("tKRGN");
    case Unit::mKRGN: return is_mainnet ? QString("mKRGN") : QString("mtKRGN");
    case Unit::uKRGN: return is_mainnet ? QString::fromUtf8("μKRGN") : QString::fromUtf8("μtKRGN");
    case Unit::ksats: return is_mainnet ? QString("ksats") : QString("tksats");
...
QString BitcoinUnits::description(Unit unit)
{
    ...
    switch(unit) {
    case Unit::KRGN:  return QString("%1Kerrigan").arg(maybe_prefix);
    case Unit::mKRGN: return QString("Milli-%1Kerrigan (1 / 1" THIN_SP_UTF8 "000)").arg(maybe_prefix);
    case Unit::uKRGN: return QString("Micro-%1Kerrigan (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)").arg(maybe_prefix);
    case Unit::ksats: return QString("Ten Nano-%1Kerrigan (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)").arg(maybe_prefix);
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
{
    switch (unit) {
    case Unit::KRGN:  return 100'000'000;
    case Unit::mKRGN: return 100'000;
    case Unit::uKRGN: return 100;
    case Unit::ksats: return 1;
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
{
    switch (unit) {
    case Unit::KRGN:  return 8;
    case Unit::mKRGN: return 5;
    case Unit::uKRGN: return 2;
    case Unit::ksats: return 0;
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
{
    switch (unit) {
    case BitcoinUnit::KRGN: return 0;
    case BitcoinUnit::mKRGN: return 1;
    case BitcoinUnit::uKRGN: return 2;
    case BitcoinUnit::ksats: return 3;
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
...
{
    switch (num) {
    case 0: return BitcoinUnit::KRGN;
    case 1: return BitcoinUnit::mKRGN;
    case 2: return BitcoinUnit::uKRGN;
    case 3: return BitcoinUnit::ksats;
    }
    assert(false);
}
} // namespace
