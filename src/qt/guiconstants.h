...
/* KerriganGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* KerriganGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Kerrigan"
#define QAPP_ORG_DOMAIN "kerrigan.network"
#define QAPP_APP_NAME_DEFAULT "Kerrigan-Qt"
#define QAPP_APP_NAME_TESTNET "Kerrigan-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Kerrigan-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Kerrigan-Qt-regtest"
