...
private:
    ...
    ShieldedTransactionsPage* shieldedTransactionsPage{nullptr};
...
public Q_SLOTS:
    ...
    /** Switch to shielded transactions page */
    void gotoShieldedTransactionsPage();
    ...
    */
    ...
    /** Update selected KRGN amount from transactionview */
