...
void AskPassphraseDialog::accept()
{
    ...
    // Avoid std::string temporaries on non-secure heap
    {
        QByteArray utf8 = ui->passEdit1->text().toUtf8();
        oldpass.assign(std::string_view{utf8.constData(), static_cast<size_t>(utf8.size())});
        utf8.fill(0);
    }
    {
        QByteArray utf8 = ui->passEdit2->text().toUtf8();
        newpass1.assign(std::string_view{utf8.constData(), static_cast<size_t>(utf8.size())});
        utf8.fill(0);
    }
    {
        QByteArray utf8 = ui->passEdit3->text().toUtf8();
        newpass2.assign(std::string_view{utf8.constData(), static_cast<size_t>(utf8.size())});
        utf8.fill(0);
    }
    ...
    case Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
                 tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR KRGN</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
