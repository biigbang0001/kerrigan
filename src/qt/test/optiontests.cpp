...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/Kerrigan/Kerrigan-Qt.conf and all else left as default,
    // kerrigan-qt should set both -listen and -listenonion to false and start successfully.
