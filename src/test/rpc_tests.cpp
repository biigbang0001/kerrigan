...
BOOST_AUTO_TEST_CASE(help_example)
{
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", args), "> kerrigan-cli -named test foo=bar b=true n=1\n");
    ...
    // test shell escape
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b'ar"}}), "> kerrigan-cli -named test foo='b'''ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b\"ar"}}), "> kerrigan-cli -named test foo='b\"ar'\n");
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"foo", "b ar"}}), "> kerrigan-cli -named test foo='b ar'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", obj_value}}), "> kerrigan-cli -named test name='{\"foo\":\"bar\",\"b\":false,\"n\":1}'\n");
    ...
    BOOST_CHECK_EQUAL(HelpExampleCliNamed("test", {{"name", arr_value}}), "> kerrigan-cli -named test name='[\"bar\",false,1]'\n");
...
BOOST_AUTO_TEST_CASE(rpc_convert_composite_commands)
{
    ...
    BOOST_CHECK_EQUAL(result[3][0].get_str(), "1.1.1.1:17120");
    BOOST_CHECK_EQUAL(result[3][1].get_str(), "1.0.0.1:17120");
    ...
    BOOST_CHECK_NO_THROW(result = RPCConvertNamedValues("protx", {
        ...
        "6fe28c0ab6f1b372c1a6a246ae63f74f931e8365e15a089c68d6190000000000",
        "1",
        "coreP2PAddrs=[\"1.1.1.1:17120\",\"1.0.0.1:17120\"]",
    ...
    BOOST_CHECK_EQUAL(result["coreP2PAddrs"][0].get_str(), "1.1.1.1:17120");
    BOOST_CHECK_EQUAL(result["coreP2PAddrs"][1].get_str(), "1.0.0.1:17120");
    ...
    BOOST_CHECK(!result[3].isArray());
    BOOST_CHECK_EQUAL(result[3].get_str(), "1.1.1.1:17120");
