...
//! (kerrigan-gui, kerrigan-node, kerrigan-wallet, kerrigand, kerrigan-qt) and each
...
public:
    ...
    virtual std::unique_ptr<interfaces::WalletLoader> makeWalletLoader(interfaces::Chain&);
