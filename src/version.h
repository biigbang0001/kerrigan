...
#ifndef KERRIGAN_VERSION_H
#define KERRIGAN_VERSION_H
...
//! BIP324 v2 transport with Kerrigan short IDs (128-167) introduced
static const int BIP324_KERRIGAN_BASELINE_VERSION = 70235;
