...
#ifndef KERRIGAN_CRYPTO_EQUIHASH_H
#define KERRIGAN_CRYPTO_EQUIHASH_H
...
public:
    ...
    std::string GetHex(size_t len) { return HexStr(Span<const unsigned char>(hash, len)); }
...
#endif // KERRIGAN_CRYPTO_EQUIHASH_H
