...
BENCHMARK(Pow_X11_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_X11_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_X11_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_X11_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_X11_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_X11_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_X11_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Blake512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Blake512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Blake512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Blake512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Blake512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Blake512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Blake512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Bmw512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Bmw512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Bmw512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Bmw512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Bmw512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Bmw512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Bmw512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Cubehash512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Cubehash512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Cubehash512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Cubehash512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Cubehash512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Cubehash512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Cubehash512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Echo512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Echo512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Echo512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Echo512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Echo512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Echo512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Echo512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Groestl512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Groestl512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Groestl512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Groestl512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Groestl512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Groestl512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Groestl512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Jh512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Jh512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Jh512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Jh512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Jh512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Jh512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Jh512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Keccak512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Keccak512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Keccak512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Keccak512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Keccak512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Keccak512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Keccak512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Luffa512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Luffa512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Luffa512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Luffa512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Luffa512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Luffa512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Luffa512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Shavite512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Shavite512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Shavite512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Shavite512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Shavite512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Shavite512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Shavite512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Simd512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Simd512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Simd512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Simd512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Simd512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Simd512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Simd512_1M, benchmark::PriorityLevel::HIGH);

BENCHMARK(Pow_Skein512_0032b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Skein512_0080b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Skein512_0128b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Skein512_0512b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Skein512_1024b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Skein512_2048b, benchmark::PriorityLevel::HIGH);
BENCHMARK(Pow_Skein512_1M, benchmark::PriorityLevel::HIGH);
