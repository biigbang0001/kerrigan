# Support for Output Descriptors in Kerrigan

Since Kerrigan v0.17, there is support for Output Descriptors. This is a
...
existing Kerrigan wallets, a convenience function `combo` is
...
All RPCs in Kerrigan will include the checksum in their output. Only
