...
Below are some notes on how to build Kerrigan for Windows.

The options known to work for building Kerrigan on Windows are:
...
Note that for WSL the Kerrigan source path MUST be somewhere in the default mount file system, for
