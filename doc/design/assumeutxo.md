...
Assumeutxo is a feature that allows fast bootstrapping of a validating kerrigand
...
considered active. This is the "traditional" mode of operation for kerrigand.
...
**Failure consideration:** if kerrigand unexpectedly halts after `m_stop_use` is set on
...
### Kerrigand restarts sometime after snapshot validation has completed

When kerrigand initializes again, what began as the snapshot chainstate is now
