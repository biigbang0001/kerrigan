...
This guide describes how to build kerrigand, command-line utilities, and GUI on OpenBSD.
...
Kerrigan includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
