When Kerrigan automatically opens outgoing P2P connections, it chooses
...
or one where a service is listening that is not related to the Kerrigan network.
...
and usually require authentication. A connection attempt (by Kerrigan,
...
Below is a list of "bad" ports which Kerrigan avoids when choosing a peer to
